    ...
    <div className="flex flex-col lg:flex-row items-center justify-between gap-12 lg:gap-24 w-full">
      ...
      <div className="w-full max-w-md bg-white/70 dark:bg-slate-800/90 backdrop-blur-xl border border-zinc-200 dark:border-slate-700 rounded-[24px] p-8 shadow-[0_8px_40px_-12px_rgba(0,0,0,0.1)] dark:shadow-[0_8px_24px_rgba(0,0,0,0.4)]">
        <div className="mb-8 text-center">
          ...
          <p className="text-sm text-zinc-500 dark:text-slate-400">Join us to get started with SupportAI</p>
        </div>
                ...
                <div className="space-y-1">
                  ...
                  <div className="relative">
                    ...
                    <input
                      ...
                      className="w-full pl-12 pr-4 py-3 text-center tracking-[0.5em] font-mono rounded-xl bg-zinc-50 dark:bg-slate-900 border border-zinc-200 dark:border-slate-600 focus:outline-none focus:ring-2 focus:ring-blue-500/50 focus:border-blue-500 transition-all text-sm text-zinc-900 dark:text-slate-50 uppercase"
                      required
                    />
                  </div>
                </div>
