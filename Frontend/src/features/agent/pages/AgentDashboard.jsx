        ...
        <div className="lg:col-span-2 space-y-4">
          <div className="flex items-center justify-between mb-2">
            <div className="flex items-center gap-3">
              ...
              <span className="px-2 py-0.5 text-[10px] font-bold uppercase bg-slate-100 dark:bg-slate-800 text-slate-400 rounded-sm">
                Current Focus
              </span>
            </div>

            <div className="flex items-center gap-2">
              <Link to="/agent/tickets" className="flex items-center gap-2 px-3 py-1.5 text-xs font-bold text-white bg-slate-900 dark:bg-slate-200 dark:text-slate-900 rounded-md">
                <Ticket size={14} /> Assigned Tickets
              </Link>

              <button className="flex items-center gap-2 px-3 py-1.5 text-xs border rounded-md">
